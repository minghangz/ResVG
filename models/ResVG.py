...
class ResVG(nn.Module):
    ...
    def forward(self, image, image_mask, word_id, word_mask, feature):
        ...
        hs = self.trans_decoder(img_feat, mask, pos_embed, word_feat, word_mask, feature)
...
def build_vgmodel(args):
    ...
    model = ResVG(pretrained_weights=args.load_weights_path, args=args)
