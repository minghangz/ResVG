...
# Meta Information
SUPPORTED_DATASETS = {
    'referit': {'splits': ('train', 'val', 'trainval', 'test', 'new_train')},
    'unc': {
        'splits': ('train', 'val', 'trainval', 'testA', 'testB', 'test', 'new_train'),
    ...
    'gref': {
        'splits': ('train', 'val', 'new_train'),
        'params': {'dataset': 'refcocog', 'split_by': 'google'}
    },
    'gref_umd': {
            'splits': ('train', 'val', 'test', 'new_train'),
...
class VGDataset(Dataset):
    ...
    def getitem__PIL(self, idx):
        ...
        if 'mask' in target:
            ...
            return image, mask, target, feature
